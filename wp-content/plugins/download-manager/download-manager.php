...
class WordPressDownloadManager{
    ...
    function registerScripts(){
		...
		/*wp_register_style('wpdm-front', plugins_url() . '/download-manager/assets/css/customgobsv.css');*/
    ...
    function enqueueScripts()
    {
       ...
       /* wp_enqueue_style('choosen-css', plugins_url('/download-manager/assets/css/customgobsv.css'), 999999); Personalizacion GobSV*/
