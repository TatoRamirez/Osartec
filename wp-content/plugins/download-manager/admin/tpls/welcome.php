<script  src="<?php echo includes_url();?>/js/jquery/jquery.form.min.js"></script> <!--type="text/javascript"-->
...
<link rel="stylesheet" href="<?php echo plugins_url('/download-manager/assets/bootstrap3/css/bootstrap.css');?>" /><!--type="text/css" -->
